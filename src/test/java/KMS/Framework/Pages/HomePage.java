...
public class HomePage extends WebDrivers {
    ...
    public void clickOnProjectsTab() {
        ...
        longWait().until(ExpectedConditions.visibilityOf((WebElement) projectsPage.searchButton));
    }
    ...
    public void verifyProjectsElements() {
        ...
        longWait().until(ExpectedConditions.visibilityOf((WebElement) projectsPage.projectNameElement));
        String projectTitle = projectsPage.projectNameElement.getText();
        Assert.assertEquals(projectTitle, "KMS-Automation");
//        verifyMetricTitles();
    }

    private void verifyMetricTitles() {
